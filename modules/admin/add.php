            ...
            if(isset($_GET['addbatch'])){ ?>
                <div align="center">
                    <form method="post">
                        ...
                        <br><b>Timings: </b><input type="text" name="timings" placeholder="Enter Batch timing">
          ...
          <?php
                if(isset($_POST['batchadd'])){
                    ...
                    if($sql_select_batch_query_chekc>0)
                    {
                        ...
                        $sql_insert_into_batch = "INSERT INTO batches (batch,timings,year,course,center) VALUES ('$batch_get','$timings_get','2022','$course','$center')";
            ...
            <?php
                if(isset($_POST['inserttimetable'])){
                 ...
                 if($sq_get_result>0){
                     ...
                     $sqli_insert = "INSERT INTO timetable(center, batch, subject, timing, eid, day, course) VALUES ('$center','$get_batch','$get_subject','$get_timings','$get_teacher_eid','$get_day','$course')";

        ...
        <?php if(isset($_GET['addteacher'])) {
            ...
            $eid_get_from_sql = preg_replace_callback("|(\d+)|", "increment", $eid_get_from_sql);
                    ...
                    if (isset($_POST['add'])) {
                        ...
                        $sql_get_insert = "INSERT INTO teachers (eid, fname, lname, email, mobile, address, position, subject, course, center, dateofjoining, status) VALUES ('$eid_get_from_sql','$te_fname','$te_lname','$te_email','$te_mobile','$te_address','$te_position','$te_subject','$course','$center','$te_dateofjoining','yes')";
                    ...
                    if ($sql_query_search_result_check > 0) {
                        ...
                        if ($rowss['position'] != 'sadmin') {
                            ...
                            if (isset($_POST['update'])) {
                                ...
                                $sql_q_update = "UPDATE teachers SET fname='$te_fname',lname='$te_lname',email='$te_email',mobile='$te_mobile',address='$te_address' WHERE eid='$get_teacherid' AND center='$center' AND course='$course'";

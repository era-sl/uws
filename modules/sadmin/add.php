...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    if($status == 'yes' || $status == 'Yes') {
        ...
        <body>
        <h2 align="center" style="color: blue"><?php echo "Owner-UWS Academy" ?></h2>
        <div class="header">
        ...
        <div id="mySidenav" class="sidenav">
            ...
            <a href="index.php" class="logo"><span style="color:white;font-size:50px">UWS Academy</span></a>
        ...
        if(!isset($_GET['addadmin']) AND !isset($_GET['updateadmin']) AND !isset($_GET['addcenters'])  AND !isset($_GET['updatecenter'])){
            ...
            <?php
                if (isset($_POST['add'])) {
                    ...
                    $sql_get_insert = "INSERT INTO teachers(eid, fname, lname, email, mobile, address,  position, course, dateofjoining, status) VALUES ('$eid_get_from_sql','$te_fname','$te_lname','$te_email','$te_mobile','$te_address','$te_position','$te_course','$te_dateofjoining','yes')";
                ...
                if(isset($_GET['updateadmin']) AND isset($_GET['eid'])){
                    ...
                    if($get_details_of_admin_check > 0){
                     $admin_details = mysqli_fetch_assoc($get_details_of_admin_query); ?>
                        <div align="center">
                            <h4>Update admin <span style="color: blue;">(<?php echo $get_eid?>)</span></h4>
                            <br>
                            <form method="post">
                    ...
                    if(isset($_POST['update_admin'])){
                        ...
                        $admin_update = "UPDATE teachers SET fname='$admin_fname',lname='$admin_lname',email='$admin_email',mobile='$admin_email',mobile='$admin_mobile',address='$admin_address' WHERE eid='$get_eid'";
            ...
            if(isset($_GET['addcenters'])){?>
                ...
                <div align="center">
                    <h4>Add Center</h4>
                    <form method="post">
                        <b>Center code : </b><input type="text" name="center" placeholder="Enter Center Code" >
                        <b>Date Of Start: </b><input type="date" name="dateoofbuild" placeholder="Enter Date OF Build"><br>
                        <b>Enter Course</span> : </b><input type="text" name="course" placeholder="Enter Course"><br>
           ...
           <?php
                if(isset($_POST['addcenter'])){
                    ...
                    $select_from_centers = "SELECT * FROM centers WHERE center='$center_code' AND coures='$center_course'";
                    ...
                    if(mysqli_num_rows($select_from_centers_q) > 0){
                        ...
                        $insert_into_centers = "INSERT INTO centers(center,  dateofbuild,coures) VALUES ('$center_code','$center_date','$center_course')";

...
if(isset($_SESSION['id']) && isset($_SESSION['username'])){
    ...
    if($status == 'yes' || $status == 'Yes') {
        ...
        <div align="center">
            ...
            <form  method="post">
                <b>Old Password: </b><input type="password" name="oldpassword" placeholder="Old Password" required><br>
                <b>New Password: </b><input type="password" name="newpassword_one" placeholder="New Password" required><br>
                <b>Confirm Password: </b><input type="password" name="newpassword_again" placeholder="Confirm Password" required><br>
